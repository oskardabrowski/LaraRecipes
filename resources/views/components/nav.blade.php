<nav class="w-100 h-10 p-2 border-bottom d-flex justify-content-between">
    ...
    <nav class="nav">
        ...
        {{-- prettier-ignore --}}
            <a class="nav-link" href="#"><i style="margin-right: .5rem;" class="fa-solid fa-user"></i>My account</a>
    </nav>
</nav>
